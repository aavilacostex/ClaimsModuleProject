...
Public Class DownloadDoc
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            Dim path = context.Session("filePathExcelOutput")
        ...
        Catch ex As Exception
            ...
            writeLog(strLogCadenaCabecera, Logs.ErrorTypeEnum.Information, "User Logged In Claims Web Application: " + userid, "Login at time: " + DateTime.Now.ToString())
        End Try
    ...
    Public Sub writeLog(strLogCadenaCabecera As String, strLevel As Logs.ErrorTypeEnum, strMessage As String, strDetails As String)
        ...
        objLog.WriteLog(strLevel, "CostexEA" & strLevel, strLogCadena, user, strMessage, strDetails)
    End Sub
