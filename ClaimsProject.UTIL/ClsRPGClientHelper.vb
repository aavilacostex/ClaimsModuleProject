...
Public Class ClsRPGClientHelper
    ...
    Public Sub New()
        ConString = ConfigurationManager.AppSettings("ConnectionStringOdbc").ToString()
    ...
    Public Function GetDataFromDatabase(sqlStatement As String, Optional ByRef dsResult As DataSet = Nothing, Optional dt As DataTable = Nothing) As Integer
